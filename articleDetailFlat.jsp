    ...
    <table summary="Buttons" border="0" cellpadding="0" cellspacing="0">
      <tbody>
        <tr>
          ...
          <td class="jive-icon-label"><a id="jive-reply-thread" href="">Reply this post</a> </td>
        </tr>
      </tbody>
    </table>
  </div>
            ...
            <div class="jive-message-list">
              <div class="jive-table">
				...
				for (int i = 0; i < articles.size(); i++) {
					...
					String floor = (i == 0 ) ? "Top floor" : i + " floor";
				%>
                <!-- iteration start -->
                                ...
                                <td width="1%"><div class="jive-buttons">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td class="jive-icon"><a href="http://www.google.com" title="Reply this post"><img src="images/reply-16x16.gif" alt="Reply this post" border="0" height="16" width="16"></a> </td>
                                          <td class="jive-icon-label"><a href="reply.jsp?id=<%=a.getId()%>&rootId=<%=a.getRootId() %>" title="Reply this post">Reply</a> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div></td>
