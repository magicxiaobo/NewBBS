...
<%
	...
	if (action != null && action.trim().equals("post")) {
		...
		rsKey.next();
		rootId = rsKey.getInt(1);		//拿到产生的第一个RETURN_GENERATED_KEYS，也就是rootId
              ...
              <div class="jive-table">
                <div class="jive-messagebox">
                	...
                	<form action="post.jsp" method="post">
                		...
                		内容：<textarea id="myclass" name="cont" rows="15" cols="80"></textarea>
                		<br>
...
<ckeditor:replace replace="myclass" basePath="/NewBBS/ckeditor/" />
</body>
</html>
